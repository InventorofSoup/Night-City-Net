(function () {
  ...
  const legit = [
    ["legit/spider-cyberchair.webp", "Rocklin Spider Cyberchair"],
    ["legit/microcutie.webp", "MicroCutie Personal Defense"],
    ["legit/superflash.webp", "Superflash Jacket"],
    ["legit/trauma-medscan.webp", "Trauma Team MedScan"],
    ["legit/ziggurat.webp", "Ziggurat City Database"],
    ["legit/garden.webp", "The Garden"],
    ["legit/digital-gladiator.webp", "Digital Gladiator"],
    ["legit/cybereye.webp", "Sponsored Cybereye"],
    ["legit/dynalar.webp", "Dynalar Cyberhand"],
    ["legit/biotechnica-health.webp", "Biotechnica Health Monitor"],
    ["legit/masetto.webp", "Masetto Holo-Wear"],
    ["legit/fire-brand.webp", "Fire Brand Bunker Gear"],
    ["legit/tanson-bellhop.webp", "Tanson Bellhop"],
    ["legit/killstrom.webp", "Killstrom Sonic Boom Amp"],
    ["legit/drink-master.webp", "Drink Master 3000"],
    ["legit/habitat.webp", "One Touch Habitat"],
    ["legit/combat-cabb.webp", "Combat Cabb"],
    ["legit/aerocab.webp", "Aerocab"],
    ["legit/ncart.webp", "NCART"],
    ["legit/playland.webp", "Playland by the Sea"],
    ["legit/elflines.webp", "Elflines Online"],
    ["legit/kibble.webp", "Kibble Krunch"],
    ["legit/bc-dynalar-fingers.webp", "Dynalar Modular Finger Enthusiast"],
    ["legit/bc-laser-jacket.webp", "Laser Light Street Jacket"],
    ["legit/bc-doberman.webp", "KTech Doberman 500"],
    ["legit/bc-mr-biscuit.webp", "Mr. Biscuit Multi-Food Processor"],
    ["legit/bc-aerial-sphere.webp", "WorldSat Aerial Sphere"],
    ["legit/bc-jetboy.webp", "Tanson JetBoy"],
    ["legit/bc-grundy.webp", "The Grundy"],
    ["legit/bc-boomerang.webp", "Ranger Combat Boomerang"],
    ["legit/bc-rush-revolution.webp", "Segotari Rush Revolution"],
    ["legit/bc-zonda.webp", "Zonda Metrocar"],
    ["legit/miller.webp", "Miller Protection"],
    ["legit/neonova.webp", "NeoNova"],
    ["legit/companion.webp", "Companion Technologies"],
    ["legit/vektor.webp", "Vektor Dataforts"],
    ["legit/vortec.webp", "Vortec Precision Systems"]
  ].map(function (entry) { return { src: entry[0], label: entry[1], scam: false }; });

  const scams = [
    ["scam/scam-01-euroclear-refund.webp", "Unclaimed account restitution"],
    ["scam/scam-02-rapid-angel.webp", "Free emergency coverage"],
    ["scam/scam-03-memory-chip-liquidation.webp", "Mil-spec memory chips"],
    ["scam/scam-04-civic-warrant.webp", "Civic warrant detected"],
    ["scam/scam-05-kibble-futures.webp", "Kibble Futures"],
    ["scam/scam-06-human-trial.webp", "Human Trial 7"],
    ["scam/scam-07-container-homes.webp", "Luxury container homes"],
    ["scam/scam-08-mara-transit.webp", "Mara needs your help"],
    ["scam/scam-09-estate-beneficiary.webp", "Estate beneficiary located"],
    ["scam/scam-10-agent-upgrade.webp", "Agent 12 upgrade"],
    ["scam/scam-11-channel-88-viewer-reward.webp", "Channel 88 viewer reward"],
    ["scam/scam-12-power-disconnection.webp", "Grid disconnection pending"],
    ["scam/scam-13-cyberware-warranty.webp", "Cyberware warranty extension"],
    ["scam/scam-14-courier-job-bond.webp", "MetroFlash courier recruitment"],
    ["scam/scam-15-pet-restoration.webp", "SecondTail pet restoration"],
    ["scam/scam-16-radiopure-detox.webp", "RadioPure detox patch"],
    ["scam/scam-17-identity-reset.webp", "Credstar identity reset"],
    ["scam/scam-17-identity-reset-banner.webp", "Credstar identity reset"],
    ["scam/scam-18-braindance-refund.webp", "Braindance refund approved"],
    ["scam/scam-19-home-safety-audit.webp", "Mandatory home safety audit"],
    ["scam/scam-20-relief-fund.webp", "Children of the Red Relief Fund"],
    ["scam/scam-21-preparatory-school.webp", "Aras Heights Preparatory"],
    ["scam/scam-22-luck-grid-lottery.webp", "Night City Luck Grid"],
    ["scam/scam-23-identity-breach-recovery.webp", "Datavault recovery authority"],
    ["scam/scam-24-iron-saint-protection.webp", "Iron Saint personal defense"],
    ["scam/scam-25-eldergrove-game-item.webp", "Eldergrove founder armor"]
